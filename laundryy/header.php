...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-float" style="background-color: #e3f2fd;">
      <div class="container">
        <a href="header.php" class="navbar-brand">Laun<span class="text-primary">Dry.</span></a>
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-lg-4 pt-3 pt-lg-0">
            ...
            <li class="nav-item">
              <a href="pesan.php" class="nav-link">List Paket</a>
            </li>
            <?php
            }
            ?>
            <li class="nav-item">
              <a href="histori.php" class="nav-link">Transaksi</a>
            </li>
          </ul>

          <div class="ml-auto">
            <a href="logout.php" class="btn btn-outline rounded-pill">Logout</a>
          </div>
        </div>
      </div>
    </nav>
